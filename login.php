...
<body class="bg-background text-on-surface font-sans min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="glass-card rounded-3xl p-8 shadow-sm">
            <h2 class="text-2xl font-bold mb-6 text-center"><?= $lang['login'] ?></h2>
            ...
            <div class="mt-8 text-center">
                <a href="register.php" class="text-primary hover:underline text-sm font-semibold"><?= $lang['no_account'] ?></a>
            </div>
